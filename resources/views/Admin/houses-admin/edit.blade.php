...
<div class="form-group">
 ...
 <div class="alert alert-danger shadow" role="alert" style="border-left:#721C24 5px solid; border-radius: 0px">
   ...
   @enderror
   <div class="col"><div class="form-group">
    <label class="col-sm-2 col-form-label text-warning bg-light rounded-pill " for="nomevent">Favorite</label>
                
    <input type="Number" value="{{$house->favoir}}" name="favoirh" @error('favoirh') is-invalid @enderror class="form-control" id="exampleFormControlInput1" placeholder="0">
  </div>
