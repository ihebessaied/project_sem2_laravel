<head>
  ...
  <form action="{{action('Admin\HouseController@store')}}" method="POST" >
    @csrf
      ...
      <div class="modal-body">
       ...
       <div class="input-group mb-3 dipal">
        ...
        <div class="input-group mb-3 dipal">
          ...
          <input type="text" value="" class="form-control @error('Image') is-invalid @enderror" name="house_image" placeholder="Image" aria-label="Username">
          </div>
          @error('Image')
          {{-- <div class="alert alert-danger">{{ $message }}</div> --}}
          <div class="alert alert-danger  alert-dismissible fade show">
